...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let email = UserDefaults.standard.value(forKey: "email") {
            if let password = UserDefaults.standard.value(forKey: "password") {
                FIRAuth.auth()?.signIn(withEmail: email as! String, password: password as! String) { (user, error) in
                    if error != nil {
                        print("Error: Login w/ NSUserDefaults failed.")
                    } else {
                        let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
                        let initialViewController : UIViewController = storyboard.instantiateViewController(withIdentifier: "Reveal") as UIViewController
                ...
                let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
                let initialViewController : UIViewController = storyboard.instantiateViewController(withIdentifier: "Start") as UIViewController
                self.window = UIWindow(frame: UIScreen.main.bounds)
                self.window?.rootViewController = initialViewController
                self.window?.makeKeyAndVisible()
            }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "ecoh", withExtension: "momd")!
